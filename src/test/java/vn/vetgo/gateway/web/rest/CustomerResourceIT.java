...
class CustomerResourceIT {
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getIdPartner()).isEqualTo(DEFAULT_ID_PARTNER);
    }
    ...
    void putExistingCustomer() throws Exception {
        ...
        assertThat(testCustomer.getIdPartner()).isEqualTo(UPDATED_ID_PARTNER);
    }
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.name(UPDATED_NAME).address(UPDATED_ADDRESS).status(UPDATED_STATUS).idPartner(UPDATED_ID_PARTNER);
