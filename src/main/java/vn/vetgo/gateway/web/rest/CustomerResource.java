...
import vn.vetgo.gateway.repository.CustomerRepository;
import vn.vetgo.gateway.service.CustomerService;
import vn.vetgo.gateway.service.dto.CustomerDTO;
import vn.vetgo.gateway.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link vn.vetgo.gateway.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
