...
describe('TransactionLog routing resolve service', () => {
  ...
  let routingResolveService: TransactionLogRoutingResolveService;
  ...
  beforeEach(() => {
    ...
    routingResolveService = TestBed.inject(TransactionLogRoutingResolveService);
  ...
  describe('resolve', () => {
    it('should return ITransactionLog returned by find', () => {
      ...
      expect(resultTransactionLog).toEqual({ id: 123 });
    });
