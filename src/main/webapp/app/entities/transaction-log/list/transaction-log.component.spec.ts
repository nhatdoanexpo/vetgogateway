...
describe('TransactionLog Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'transaction-log', component: TransactionLogComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.transactionLogs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
