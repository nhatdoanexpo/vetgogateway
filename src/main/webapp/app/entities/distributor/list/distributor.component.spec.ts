...
describe('Distributor Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'distributor', component: DistributorComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.distributors?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to distributorService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDistributorIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDistributorIdentifier).toHaveBeenCalledWith(entity);
